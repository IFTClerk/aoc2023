MODULE UTILS
  ...
  INTERFACE PRINTMAT
     PROCEDURE PRINTMAT_I, PRINTMAT_I64, PRINTMAT_C, PRINTMAT_L
...
ELEMENTAL LOGICAL FUNCTION ISEVEN(i)
  INTEGER, INTENT(IN) :: i

  iseven = MODULO(i,2).EQ.0
END FUNCTION ISEVEN
...
SUBROUTINE PRINTMAT_I64(mtx)
  INTEGER(KIND=INT64), DIMENSION(:,:) :: mtx
  INTEGER i, nrow, ncol

  nrow = SIZE(mtx, DIM=1)
  ncol = SIZE(mtx, DIM=2)
  DO i = 1,nrow
     WRITE(6, '(1X,*(I0,6X))') mtx(i,:)
  END DO
END SUBROUTINE PRINTMAT_I64
...
SUBROUTINE PRINTMAT_L(mtx)
  LOGICAL, DIMENSION(:,:) :: mtx
  INTEGER i, nrow, ncol

  nrow = SIZE(mtx, DIM=1)
  ncol = SIZE(mtx, DIM=2)
  DO i = 1,nrow
     WRITE(6, '(1X,*(L1,1X))') mtx(i,:)
  END DO
END SUBROUTINE PRINTMAT_L
